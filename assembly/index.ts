...
export function call(output: Buffer, input: Buffer): void {
  ...
  var message : io.cloudevents.v1.CloudEvent = Protobuf.decode<io.cloudevents.v1.CloudEvent>(array, io.cloudevents.v1.CloudEvent.decode);
  message.attributes.set("one", new io.cloudevents.v1.CloudEvent.CloudEventAttributeValue(false,0,"two"));
  var result : ArrayBuffer = Protobuf.encode<io.cloudevents.v1.CloudEvent>(message, io.cloudevents.v1.CloudEvent.encode).buffer;
